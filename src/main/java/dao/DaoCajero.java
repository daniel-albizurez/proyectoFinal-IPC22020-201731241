 ...
 * @author DANIEL
 */
public class DaoCajero extends DaoUsuarios<Cajero>{
    ...
    @Override
    protected PreparedStatement prepareInsert(Cajero obj) {
    ...
    @Override
    protected PreparedStatement prepareUpdate(Cajero obj) {
    ...
    @Override
    protected PreparedStatement prepareDelete(Cajero obj) {
    ...
    @Override
    protected Cajero setObject(ResultSet result) {
        Cajero found = new Cajero();
        try {
            if (result.first()) {
